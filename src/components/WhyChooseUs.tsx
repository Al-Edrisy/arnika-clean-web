...
const WhyChooseUs: React.FC = () => {
  ...
  const benefits = [
    { 
      ...
      text: t('eco_friendly', 'Eco-friendly products'),
    ...
    { 
      ...
      text: t('professional_team', 'Professional team'),
    ...
    { 
      ...
      text: t('quality_guarantee', 'Quality guarantee'),
    ...
    { 
      ...
      text: t('affordable_prices', 'Affordable prices'),
  ...
  const stats = [
    { 
      value: 500, 
      label: t('clients_count', '500+ Happy Clients'),
      icon: "👥"
    },
    { 
      value: 1000, 
      label: t('projects_count', '1000+ Projects'),
      icon: "✅"
    },
    { 
      value: 10, 
      label: t('experience_count', '10+ Years Experience'),
      icon: "🏆"
    }
  ];
    ...
    <section id="why-choose-us" className="py-20 px-4 md:px-10 lg:px-20">
      <div className="container mx-auto">
        <IntersectionObserver>
          <h2 className="section-title">{t('why_choose_us_title', 'Why Choose Us?')}</h2>
        </IntersectionObserver>
        
        <div className="flex flex-col md:flex-row gap-12 mt-12">
          <IntersectionObserver threshold={0.2} className="w-full md:w-1/2 order-2 md:order-1">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              {stats.map((stat, index) => (
                <div key={index} className="bg-zinc-900 p-6 rounded-lg text-center hover:transform hover:scale-105 transition-all duration-300 h-full">
          ...
          <IntersectionObserver threshold={0.2} className="w-full md:w-1/2 order-1 md:order-2">
